	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
		<div class="wrapper wrapper--w680">
			<div class="card card-1">
				...
				<div class="card-body">
					<h2 class="title">Add Player Details</h2>
					
					
					<form:form action="player_save_new_player.htm" method="post"
						...
						<div class="input-group">
							<div class="rs-select2 js-select-simple select--no-search">
								...
								<select name="playerLevel"><option value="">PLAYER
										LEVEL( 5 to 10)</option></select>
								<div class="select-dropdown"></div>
							</div>
						</div>
						...
						<div class="input-group">
							<div class="rs-select2 js-select-simple select--no-search">
								...
								<select name="matchesPlayed"><option value="">PLAYED
										MATCHES (UP TO 500)</option></select>
								<div class="select-dropdown"></div>
							</div>
						</div>
						...
						<div class="input-group">
							<div class="rs-select2 js-select-simple select--no-search">
								...
								<select name="matchesWon"><option value="">WON
										MATCHES (UP TO 500)</option></select>
								<div class="select-dropdown"></div>
							</div>
						</div>
						...
						<div class="input-group">
							<div class="rs-select2 js-select-simple select--no-search">
								...
								<select name="matchesLost"><option value="">LOST
										MATCHES (UP TO 500)</option></select>
								<div class="select-dropdown"></div>
							</div>
						</div>
						...
						<div class="input-group">
							<div class="rs-select2 js-select-simple select--no-search">
								...
								<select name="leaguePoints"><option value="">LEAGUE
										POINTS</option></select>
								<div class="select-dropdown"></div>
							</div>
						</div>
