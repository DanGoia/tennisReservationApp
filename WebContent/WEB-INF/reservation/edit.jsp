	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
		<div class="wrapper wrapper--w680">
			<div class="card card-1">
				...
				<div class="card-body">
					<h2 class="title">Edit Reservation Details</h2>
					<form:form action="reservation_save.htm" method="post"
						commandName="reservation" name="register_form" id="register_form">
						...
						<div class="input-group">
							<form:input path="courtNumber.id" class="input--style-1" type="number"
								min="1" max="100" onfocus="this.value=''" value="COURT ID" placeholder="COURT #ID"
								name="courtNumber.id" />
						</div>
							<div class="input-group">
						...
						<div class="input-group">
							<form:input path="p.id" class="input--style-1" type="number"
								onfocus="this.value=''" value="PLAYER #ID"
								placeholder="PLAYER #ID" name="p.id" />
						</div>
						...
						<div class="p-t-20">
							<button class="btn btn--radius btn--green" type="submit">Save
								Changes</button>
